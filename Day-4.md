...
--- Before Day-4 ---
I already knew I knew the basic concepts of websites, browsers, and APIs, but had limited understanding of HTTP methods, status codes, and network debugging.
...
--- After Day-4 ---
I learned these things as well, apart from the checklist I learned how HTTP methods work, 
how to debug requests using DevTools, how to test APIs with cURL, how headers like User-Agent
affect requests, and how to build and test simple APIs using FastAPI and Swagger UI.
